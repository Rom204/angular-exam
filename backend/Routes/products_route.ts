...
// import {Products, Urls} from '../Utils/urls';

// // generic router 
// const router = express.Router();
// router.get("/", async (request: Request, response: Response, next: NextFunction) => {
//   response.status(200).json("products controller is working");
// })

// // gets information from DB
// router.get(Products.getAllProductsURL, async (request: Request, response: Response, next: NextFunction) => {
//   response.status(200).json( await logic.getAllProducts())
// })
